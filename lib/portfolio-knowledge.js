...
// Structured knowledge base for the RAG chatbot
...
export const chunks = [
  {
    ...
    content: `Kishore Kumar Ramkumar is an AI/ML Engineer and Data Scientist pursuing a Master of Science in Data Science at Indiana University Bloomington (GPA 3.5, graduating May 2026). He specializes in building production-ready machine learning systems, distributed data pipelines, RAG pipelines, multi-agent AI systems, and full-stack web applications. He is open to full-time opportunities in AI/ML Engineering, Data Engineering, and Full-Stack Development.`,
...
Backend: REST APIs, Microservices, Distributed Systems, Event-Driven Architecture, HTTP, Message Queues.`,
  ...
  },
  {
    ...
    content: `Machine Learning & AI: PyTorch, TensorFlow, RAG (Retrieval-Augmented Generation), FAISS, FAISS-GPU, Model Serving, NLP (spaCy, NLTK, OpenCV), LangGraph, LangChain, AI Agents, Large Language Models, Multi-Agent Systems, LLM APIs (Ollama, Hugging Face), fine-tuning (LoRA, QLORA, PEFT), Transformers, Agentic Workflows, Prompt Engineering, Whisper, pyannote.audio.
Vector Databases & Retrieval: FAISS (GPU), Embedding Models, Semantic Search.
...
– Built automated post-processing pipelines to generate structured Final Draft XML and JSON transcript datasets for downstream ML and NLP analysis.`,
...
– Built a RAG-based chatbot using PyTorch, Hugging Face Transformers, and FAISS-GPU to enable semantic search over domain-specific automotive documents, deployed via FastAPI on AWS EKS.
...
– Availability: Open to full-time opportunities in AI/ML Engineering, Data Engineering, and Full-Stack Development starting May 2026.`,
...
– A 10-agent pipeline using LangGraph combining audio (Whisper, pyannote.audio), video (LightASD), and NLP (LoRA-tuned Llama-3.2-11B) modalities.
– Achieving 85–95% speaker attribution accuracy across 1,529+ dialogue turns.
– Running production inference on NVIDIA A100 GPU clusters via SLURM on Indiana University's Carbonate/BigRed200 HPC systems.
– Processing 15+ years of archival broadcast television data and generating structured XML/JSON transcripts.
