...
export const workAuthorization = {
  currentStatus: "STEM OPT — Kishore is actively authorized to work in the United States right now. He is on STEM OPT (3 years of work authorization) valid through approximately 2028. No employer visa action is required to begin work.",
  optDetails: "Graduated with MS Data Science from Indiana University (May 2026). Now on STEM OPT, which provides 3 years of US work authorization without any H-1B sponsorship needed. Authorization runs through approximately 2028.",
  sponsorship: "Kishore does NOT require H-1B sponsorship to begin work. He can start immediately under his current STEM OPT authorization. H-1B may be considered after STEM OPT expires around 2028, but no visa action is needed now.",
  startDate: "Available to start full-time work immediately.",
  ...
  sponsorshipFlexibility: "No sponsorship is required now. STEM OPT is valid through approximately 2028. Open to discussing future H-1B transition timing with employers, but there is no immediate visa burden.",
  citizenship: "Not a US citizen or permanent resident, but fully authorized to work in the US. On STEM OPT following May 2026 graduation — no employer visa action required to hire."
};
...
export const chunks = [
  {
    ...
    content: `Kishore Kumar Ramkumar is a Software Engineer focused on ML and AI systems, pursuing a Master of Science in Data Science at Indiana University Bloomington (GPA 3.5, graduating May 2026). He builds production systems across data pipelines, ML training, and multi-agent LLM stacks. He is open to full-time opportunities in ML Engineering, Software Engineering, Data Engineering, LLM Engineering, and Agentic Engineering, and is open to relocate anywhere in the US.`,
...
– Location: Bloomington, Indiana (currently); open to relocate anywhere in the US and open to remote roles based in the US
– Availability: Graduating MS Data Science (May 2026); open to full-time opportunities in ML Engineering, Software Engineering, Data Engineering, LLM Engineering, and Agentic Engineering starting May 2026.`,
...
– Citizenship: ${workAuthorization.citizenship}`,
    keywords: ['visa', 'sponsorship', 'h-1b', 'h1b', 'opt', 'stem opt', 'work authorization', 'authorized to work', 'work permit', 'eligible to work', 'citizen', 'green card', 'immigration', 'start date', 'available to start', 'f-1', 'f1', 'ead', 'location', 'relocate', 'remote', 'hybrid', 'onsite'],
    url: '#contact'
  },
  {
    id: 'research-current',
