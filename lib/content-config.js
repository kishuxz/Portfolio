...
export const projects = [
    // FEATURED PROJECTS
    {
        ...
        accomplished: 'Built a 10-agent LangGraph pipeline for archival TV transcript identity resolution',
        measured: 'Achieves 91.1% accuracy across the Letterman corpus (1982–2015), including 4 episodes at 100%',
        method: 'Orchestrated Whisper, pyannote, LoRA-fine-tuned Llama 3.2 11B, vLLM, and visual speaker signals. Designed novel Interrogative Host Rescue and LLM-based identity resolution modules with no published precedent.',
        techStack: ['LangGraph', 'Whisper', 'pyannote', 'LoRA', 'vLLM', 'A100', 'SLURM'],
        github: null,
        featured: true
    },
    {
        ...
        accomplished: 'Optimizing nanoGPT-scale language model training under fixed compute constraints',
        measured: 'Best result: 1.32 bpb in 10 minutes on 1×H100; SOTA leaderboard around 1.12 bpb',
        method: 'Implementing non-uniform FFN widths and StarReLU activation on top of the SOTA baseline for a ~16M parameter, int8-quantized, 1024-vocab training setup. Local MLX experiments on Apple Silicon, deployed to RunPod H100.',
        techStack: ['PyTorch', 'MLX', 'CUDA', 'Apple Silicon', 'RunPod', 'Quantization'],
        github: 'https://github.com/kishuxz/parameter-golf',
        featured: true
    },
    {
        title: 'Stackply — Vibe-Coding-Aware Hiring Platform',
        slug: 'stackply',
        categories: ['Featured', 'Software Engineering', 'LLM / Agents'],
        subtitle: 'Co-founder · Pre-launch',
        accomplished: 'Co-founding a two-sided IT hiring platform that detects AI-generated candidate work',
        measured: 'Designed for near-zero-cost pilots up to ~500 candidates using Groq, Gemini Flash, Supabase, Render, and Vercel',
        method: 'Designing a 13-step ML pipeline with triple verification across declared profile data, GitHub project evidence, and LinkedIn verification. Multi-provider LLM routing uses Groq Llama 3.3 70B for reasoning and Gemini Flash for extraction.',
        techStack: ['Next.js', 'Groq (Llama 3.3 70B)', 'Gemini Flash', 'Supabase', 'Render', 'Vercel'],
        website: null,
        featured: true
    },
    {
        title: 'TruthLens – LLM-Grounded Document QA',
        slug: 'truthlens-rag',
        categories: ['LLM / Agents', 'Hackathon'],
        accomplished: 'Built a citation-grounded LLM system for querying unstructured documents with retrieved context and grounded responses',
    ...
    },
    {
        ...
        slug: 'networkmap',
        categories: ['Data Visualization', 'Open Source'],
