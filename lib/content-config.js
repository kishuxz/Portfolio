...
export const personalInfo = {
    ...
    availability: "Graduating MS Data Science (May 2026) · Open to ML, SDE, Data Engineering, LLM, and Agentic Engineering roles · Open to relocate anywhere in the US",
    social: {
...
export const projects = [
    // FEATURED PROJECTS
    {
        ...
        accomplished: '10-agent LangGraph pipeline for multimodal speaker diarization across 30+ years of archival Late Show with David Letterman footage (1982–2015)',
        measured: '91.1% speaker resolution accuracy with 4 episodes at 100%; novel Interrogative Host Rescue (IHR) module and LangGraph-based identity resolution agent — no published precedent; targeting INTERSPEECH 2027 / EMNLP 2026 / ACL NLP4DH',
        ...
        techStack: ['LangGraph', 'Whisper large-v3', 'pyannote 3.x', 'LoRA', 'vLLM'],
        github: 'https://github.com/kishuxz/speaker-diarization',
        featured: true
    },
    {
